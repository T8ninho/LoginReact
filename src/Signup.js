    ...
    const signupWithUsernameAndPassword = async (e) => {
        ...
        if (password === confirmPassword) {
            try {
                ...
                setNotice("Desculpe, algo deu errado. Por favor, tente novamente.");
            }     
        } else {
            setNotice("As senhas não coincidem. Por favor, tente novamente.");
        }
    };
            ...
            <div className="row justify-content-center">
                <form className="col-md-4 mt-3 pt-3 pb-3">
                    ...
                    <div className="form-floating mb-3">
                        ...
                        <label htmlFor="signupEmail" className = "form-label">Digite um endereço de e-mail</label>
                    </div>
                    <div className="form-floating mb-3">
                    ...
                    <div className="mt-3 text-center">
                        <span>Você já tem conta? <Link to="/">Clique aqui.</Link></span>
                    </div>                    
                </form>
            </div>
        </div>
